...
/**
 * ClassName LogisticsEntityFileInfoEntity
 * Description 物流菜单文件详情实体
 *
 * @author 平台管理员
 * @version 7.0
 ...
 */
@Data
@TableName("logistics_entity_file_info")
@EqualsAndHashCode(of = { "id" }, callSuper = false)
public class LogisticsEntityFileInfoEntity extends AbstractEntity<FileInfoVO> implements Serializable {
