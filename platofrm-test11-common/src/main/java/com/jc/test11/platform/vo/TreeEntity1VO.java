 ...
 * @date 
 */
@ApiModel(value = "TreeEntity1VO", description = "树形工作流菜单")
@Data
@NoArgsConstructor
@AllArgsConstructor
@ToString
@EqualsAndHashCode(of = { "id" }, callSuper = false)
public class TreeEntity1VO extends AbstractVO implements Serializable
{
     ...
     * 实体编码
     */
    public static final String IS_ENTITY_CODE = "7c426a9a28004710a0ef1dcf75d1f9af";
    ...
    private List<TreeEntity1VO> children;

    public TreeEntity1VO(Long id)
    {
        this.id = id;
    }
    /**
